...
const fileWatcherPluginConfig =
  wpThemeUserConfig && wpThemeUserConfig.fileWatcherPlugin
    ? wpThemeUserConfig.fileWatcherPlugin
    : null;
...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    entry: [
      ...
      // isEnvDevelopment && // wptheme remarked out
      // require.resolve('react-dev-utils/webpackHotDevClient'), // wptheme remarked out
    ...
    plugins: [
      ...
      //isEnvProduction && // wptheme remarked out -- always generate css
