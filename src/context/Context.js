...
export class Provider extends React.Component {
  constructor(props) {
    ...
    let term = props.router.match.params.term
      ? props.router.match.params.term
      : "";
    let catid = props.router.match.params.catid
      ? props.router.match.params.catid
      : "";
  ...
  buildUrl() {
    ...
    switch (this.state.restType) {
      ...
      default:
        url += this.state.slug
          ? "posts/?slug=" + this.state.slug
          : "posts/?page=" + this.state.currentPage;
        break;
    }
