...
const seoBlockData = {
  heading: "Reason to Join Us",
  image: seoImg,
  content: `<p>We’re entertaining 30+ million people around the world every month through a growing catalog of 350+ unique casual HTML5 games optimized for smartphones, tablets and desktop – across all web and mobile platforms.</p>
   <p><b>You want to add free HTML5 games to your site or app?
You don’t have a mobile optimized site yet?</b></p>
    <p>Let us help you to generate constant <b>growing mobile advertising</b> and aming <b>revenue streams</b>. Get in touch with us and learn how SOFTGAMES can help you!<br/>
    Select up to 350+ HTML5 games, add them to your website or app and start making money today!</p>
    `,
  contactUsBtn: false
};
...
const Company = props => {
  ...
  useEffect(() => {
    ...
    const loadData = () => {
      try {
        axios
          .get(`${apiEndpoints.news}?orderby=date&order=DESC&per_page=6`, {
    ...
    <Layout>
      ...
      <section id="our-story" className="ourStory withIllustration">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2 className="ourStory-heading">Our Story</h2>
              <TimelineSlider />
            </div>
          </div>
        </div>
      ...
      <section id="press-room" className="pressRoom">
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2 className="pressRoom-heading">Press Room</h2>
            </div>
          </div>
          <div className="row">
      ...
      <section id="getInTouchForm" className="getInTouch withIllustration">
        <div className="container">
          <div className="row">
            <div className="col-12">
